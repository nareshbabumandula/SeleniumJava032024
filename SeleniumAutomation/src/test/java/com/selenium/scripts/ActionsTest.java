...
public class ActionsTest {
	...
	public void mouseActionMethods() throws InterruptedException {
		...
		try {
	        ...
	        //action.contextClick(addons).perform(); // Right click in addons menu
			...
			Assert.assertEquals(bFlag, true, "Failed to hover the mouse on 'Add-ons' and navigated to 'SpiceFlex' page since : " + message);
		}finally {
			if (bFlag) {
